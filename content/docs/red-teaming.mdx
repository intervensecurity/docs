...
3. **Adjust accordingly:**
   - **Classifier miss** → file a pattern issue at github.com/intervensecurity/aif (we'll update the shared classifier)
   - **Policy miss** → tighten or add a policy in the Console; commit your updated YAML in `packages/policy-packs/` if you self-host
