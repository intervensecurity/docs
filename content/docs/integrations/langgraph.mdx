...
Working code lives in the AIF repo:

- [`packages/sdk-python/examples/`](https://github.com/intervensecurity/aif/tree/main/packages/sdk-python/examples) — base SDK + LangChain / LangGraph / CrewAI / MCP demos
- [`examples/langchain-agent/`](https://github.com/intervensecurity/aif/tree/main/examples/langchain-agent) — minimal LangChain agent with per-tool scan (drop-in pattern for LangGraph too)
