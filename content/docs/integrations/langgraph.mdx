...
Working code samples are available on request — email
[support@intervensecurity.com](mailto:support@intervensecurity.com) for:

- A base Python SDK starter with LangChain / LangGraph / CrewAI / MCP demos
- A minimal LangChain agent template with per-tool scan (drop-in pattern for LangGraph too)
