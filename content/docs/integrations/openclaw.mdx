...
See [Troubleshooting](/docs/troubleshooting) for additional gotchas. The
OpenClaw plugin (`openclaw-interven-guard`) is published to npm —
install it as a regular OpenClaw plugin via the OpenClaw plugin manager.
